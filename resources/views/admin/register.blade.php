...
<div class="login-form pt-11">
    ...
    <form method="POST" action="{{ route('admin.register') }}">
        ...
        <div class="text-center pb-8">
            <h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Admin Sign Up</h2>
            <p class="text-muted font-weight-bold font-size-h4">Tạo tài khoản quản trị viên</p>
        </div>
